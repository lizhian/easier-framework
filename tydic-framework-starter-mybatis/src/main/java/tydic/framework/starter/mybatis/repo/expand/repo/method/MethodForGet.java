 ...
 * 查询单条数据
 */
public interface MethodForGet<T, REPO extends BaseRepo<T>> extends TypedSelf<REPO>, ColumnMethod<T> {
    /**
     * 根据主键查询
     */
    @Nullable
    ...
    default T getByCode(String code) {
        SFunction<T, ?> tableColeColumn = this.getTableColeColumnFor("getByCode");
