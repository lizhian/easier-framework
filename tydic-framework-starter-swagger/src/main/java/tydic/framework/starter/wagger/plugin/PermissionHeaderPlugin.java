...
import tydic.framework.core.plugin.auth.annotation.DeletePermission;
import tydic.framework.core.plugin.auth.annotation.GetPermission;
import tydic.framework.core.plugin.auth.annotation.MustPermission;
import tydic.framework.core.plugin.auth.annotation.MustRole;
