...
import easier.framework.test.enums.SysAppType;
...
public class SysApp implements MybatisPlusEntity {
    ...
    @BindEntityByMid(
            conditions = @MidCondition(
                    midEntity = easier.framework.test.eo.AppToDict.class
                    , selfField = easier.framework.test.eo.AppToDict.Fields.appCode
                    , selfMidField = easier.framework.test.eo.AppToDict.Fields.appCode
                    , joinMidField = easier.framework.test.eo.AppToDict.Fields.dictCode
                    , joinField = easier.framework.test.eo.SysDict.Fields.dictCode
            )
            , orderBy = @JoinOrderBy(field = BaseEntity.Fields.updateTime, isAsc = false)
    )
    private List<easier.framework.test.eo.SysDict> dictList;
