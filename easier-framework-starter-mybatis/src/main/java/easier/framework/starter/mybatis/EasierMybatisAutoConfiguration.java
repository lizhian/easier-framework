...
import easier.framework.starter.mybatis.types.DateTimeTypeHandler;
import easier.framework.starter.mybatis.types.EnumCodecTypeHandler;
...
@Slf4j
@EnableConfigurationProperties(easier.framework.starter.mybatis.MybatisDynamicProperties.class)
...
public class EasierMybatisAutoConfiguration {
    ...
    @Bean
    public DynamicDataSourcePropertiesCustomizer dynamicDataSourcePropertiesCustomizer(easier.framework.starter.mybatis.MybatisDynamicProperties dynamicProperties) {
        return properties -> {
